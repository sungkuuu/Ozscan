...
// per-wallet page cap (mega-bots can't eat the run), DB size ceiling 17GB.
...
while (Date.now() - t0 < TIME_BUDGET_MS) {
  ...
  if (Number(sz.s) > DB_CEILING) { console.log('DB ceiling 17GB reached — stopping. Review before continuing.'); process.exit(3); }
